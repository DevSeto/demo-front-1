...
@Component({
    ...
    templateUrl: '../../html/tickets/tickets-list.component.html',
})

export class TicketslistComponent   extends TicketsChildsComponent{
    ...
    //     console.log("asdasdads",fileContent,recentClick)
    //
    //     if (!recentClick && !fileContent) {
    ...
    //
    // /**
    //  * get more tickets after scroll down
    //  * @param event
    //  */
    // public scrollTickets(event: any): void {
    //     let totalTicketCount: number = 0;
    //     this.mailboxService.mailboxes.forEach((val: any, index: number): void => {
    //         if (val.id === this.mailboxId) {
    //             totalTicketCount = val[this.activeTickets + '_tickets_count'];
    ...
    //
    //     if (this.ticketService.tickets.length && totalTicketCount > this.ticketService.tickets.length) {
    ...
    //                 .then((data: any): void => {
    //                     if (data.success) {
    //                         this.ticketService.tickets.set([...(this.ticketService.tickets), ...(data.data)]);
    //                         this.ticketsTotalCount = data.total;
    //                     }
    //                 });
    //         }
