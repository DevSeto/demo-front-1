...
@Component({
    selector: 'main-header-logged',
    templateUrl: '../../html/main/main.header.logged.html',
})
export class MainHeaderLoggedComponent implements AfterViewInit {
    ...
    constructor(public userService: UsersService,
        ...
        if (!this.usersModel.getLoggedUser() || (this.usersModel.getLoggedUser() && !this.usersModel.getLoggedUser().step)) {
    ...
    public redirectToMailbox(): void {
        this.router.navigate(['/mailbox-settings/' + this.mailBoxModel.getMailboxCurrentId() + '/2']);
    }
}
