...
export class DropdownOpen implements OnDestroy {
    ...
    constructor(@Host() public dropdown: Dropdown,
        ...
        this.closeDropdownOnOutsideClick = function closeDropdownOnOutsideClick(event: any): void {
    ...
    onBlur(event: FocusEvent) {
        ...
        if (event.relatedTarget && !this.dropdown.isInClosableZone(event.relatedTarget as HTMLElement) &&
    ...
    private closeIfInClosableZone(event: Event) {
        if (!this.dropdown.isInClosableZone(event.target as HTMLElement)
