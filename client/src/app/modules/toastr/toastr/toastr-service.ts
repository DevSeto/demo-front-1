...
export class ToastrService {
  ...
  private _buildNotification(
    ...
    ins.then = (parameters: { func: any }): any => {
        const func = parameters.func;
        ins.timeCount = 0;
        if (!this.isOpen)
        this.isOpen = !!1;
        const checkInterval: any = setInterval((): void => {
        ins.timeCount += 1;
        if (ins.timeCount >= (optionsOverride.timeOut / 1000)) {
          this.isOpen = !!0;
          func();
